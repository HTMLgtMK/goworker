...
func LoggingInterceptor(l *logger.Logger) plugin.PluginInterceptor {
	return func(ctx *plugin.Context, next func() error) error {
...
func SessionInterceptor(provider plugin.SessionProvider) plugin.PluginInterceptor {
	return func(ctx *plugin.Context, next func() error) error {
		if provider != nil {
